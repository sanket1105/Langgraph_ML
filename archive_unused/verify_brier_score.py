"""
Script to verify Brier score calculation from the H2O model
"""
...
def verify_brier_score():
    """Verify Brier score calculation manually."""

    print("=== Brier Score Verification ===\n")
    ...
    try:
        model = h2o.load_model(
            "models/StackedEnsemble_AllModels_1_AutoML_13_20250618_205602"
        )
    ...
    # Recreate the test data to verify Brier score
